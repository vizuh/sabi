...
This phase does not yet claim a system-login service, universal Orca prompt interception, or live
cross-terminal execution. Those remain explicit host-integration gates below.
